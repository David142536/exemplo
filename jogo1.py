...
app_nome = Label(frame_top, text = "ADIVINHAR O NÚMERO", anchor='center', font=('verdana 14 bold'), bg=co1, fg=co3)
    ...
    def estado_do_valor(v):
        ...
        for i in resposta:
            if v == i:
                ...
                #desabilitando os botões após tentativas serem iguais a 0
                if tentativas <=0:
                    b_1['state'] = 'disable'
                    b_2['state'] = 'disable'
                    b_3['state'] = 'disable'
...
def game_over():
    ...
    b_jogar = Button(frame_corpo, command=iniciar_jogo, text = 'Jogar', width=15, font=('ivy 12 bold'), bg=co10, fg=co0, relief=RAISED, overrelief=RIDGE)
    b_jogar.place(x=100, y=150)



#configurando frame baixo
l_pontos = Label(frame_corpo, text = "Pontuação: 0", anchor='center', font=('ivy 11 bold'), bg=fundo, fg=co1)
...
l_regra1 = Label(frame_corpo, text = "Tente adivinhar o número para pontuar.", anchor='center', font=('ivy 8 bold'), bg=fundo, fg=co1)
l_regra1.place(x=40, y=80)

l_regra2 = Label(frame_corpo, text = "Se você acertar, ganhará mais 2 chances.", anchor='center', font=('ivy 8 bold'), bg=fundo, fg=co1)
l_regra2.place(x=40, y=110)

l_regra3 = Label(frame_corpo, text = "Se você errar, as suas chances irão reduzir.", anchor='center', font=('ivy 8 bold'), bg=fundo, fg=co1)
l_regra3.place(x=40, y=140)

b_jogar = Button(frame_corpo, command = iniciar_jogo, text = 'Jogar', width=30, font=('ivy 10 bold'), bg=co10, fg=co0, relief=RAISED, overrelief=RIDGE)
